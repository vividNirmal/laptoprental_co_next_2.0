  ...
  const fetchAboutUs = async () => {
    try {
      ...
      const response = await userGetRequest(
        "get-static-page?page_name=About Us"
      );
      ...
      <div className="rz-app-wrap sm:rounded-xl container mx-auto flex flex-wrap items-start justify-center gap-4 pb-10 pt-1 xl:flex-nowrap xl:px-6 2xl:px-9">
        <div className="mx-auto w-full px-2.5">
          ...
          {loading ? (
            ...
            <div className="pb-3">
              <h2 className="text-xl font-semibold text-black md:text-lg xl:text-xl 2xl:text-2xl">
                {about?.page_name}
              </h2>
              <div
                ...
                [&>ul]:mb-3 [&>ul]:list-disc [&>ul]:pl-6 [&>ol>li]:text-xs [&>ul>li]:mb-2 
            ...
            <div className="py-8 text-center">
              <p className="text-zinc-700">No content available at the moment.</p>
            </div>
          )}
        </div>
      </div>
